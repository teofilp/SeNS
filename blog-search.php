...
<body>
		...
		<div class="center">
			...
			<form id="searchForm" method="POST">
				<div class="search-bar">
					<form id="serchFrom" method="POST" action="blog-search.php">
	...
	<div class="blog-div">
		...
		<?php 
			...
			$postQuery = $database->query("SELECT * FROM posts WHERE post_tags LIKE '%$search%' ORDER BY id DESC");
			$postQuery->execute();

			if($postQuery->rowCount() == 0) {
				echo "<h1>Niciun rezultat gasit.</h1>";
			} else {
